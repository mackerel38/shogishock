...
REPORTS={
 'reports/trap_tree_benchmark':['PLAN.md','explore.py','test_tree.py','evidence.json','tree.json',
    'engine_evidence.json','prepare_confirmation.py','confirmation_plan.json','confirmation.json',
    'interpretation.json','finalize.py','analysis.md','ASTRA_HANDOFF.json','LUNA_TASK.md'],
 'reports/tactical_falsification_v2':['PLAN.md','selections.json','experiment.py','test_experiment.py',
    'results.json','engine_evidence.json','confirmation_plan.json','confirmation_results.json',
    'interpretations.json','finalize.py','analysis.md','ASTRA_HANDOFF.json','LUNA_TASK.md'],
...
def main(target):
    ...
    paths.append(Path('exports/tactical_falsification_v2_review/README.md'))
